...
1. Start the backend Express server:
   ```bash
   cd /Users/samarmustafa/Documents/1Samar/50-apps-to-launch/cv-job-match/job-research-system/job-research-mcp && npm run start:express
   ```

2. Start the frontend Vite dev server:
   ```bash
   cd /Users/samarmustafa/Documents/1Samar/50-apps-to-launch/cv-job-match/job-research-system/job-research-ui && npm run dev
   ```
